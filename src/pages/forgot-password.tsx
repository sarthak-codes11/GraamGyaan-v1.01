    ...
    <div className="flex min-h-screen flex-col items-center">
      <header className="flex h-[70px] w-full justify-center bg-blue-400 font-bold text-white">
        <div className="flex max-w-5xl grow items-center justify-between px-5">
          ...
          <div className="relative flex md:hidden" onClick={() => setMobileMenuShown((x) => !x)} role="button" tabIndex={0}>
            ...
            {mobileMenuShown && (
              <div className="absolute right-0 top-full rounded-2xl border-2 border-gray-300 bg-white font-bold text-gray-700">
                <Link className="block min-w-max cursor-pointer rounded-t-2xl px-5 py-2 hover:bg-gray-100" href="/?login">
                  Sign in
                </Link>
                <Link className="block min-w-max cursor-pointer border-t-2 border-gray-300 px-5 py-2 hover:bg-gray-100" href="/register">
                  Get started
                </Link>
      ...
      <div className="flex w-full grow flex-col items-center gap-5 px-5 pt-5 sm:w-96 sm:pt-52">
        ...
        <p className="text-center text-gray-800">We will send you instructions on how to reset your password by email.</p>
        <div className="flex w-full flex-col gap-2">
          <input className="w-full rounded-2xl border-2 border-gray-200 bg-gray-50 px-4 py-3" placeholder="Email" />
